  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-center gap-3 border-b border-black px-4 py-5">
        <div className="min-w-[180px] border border-black bg-[#ececec] px-4 py-2 text-center font-mono text-2xl font-bold tracking-[0.2em] text-black">
          {alias}
        </div>
...
export function tanqrDisplayPrintStyles(): string {
  return `
    * { box-sizing: border-box; }
    ...
    .tanqr-print-root .alias-box { display: inline-block; min-width: 180px; border: 1px solid #000; background: #ececec; padding: 8px 16px; font-family: monospace; font-size: 24px; font-weight: 700; letter-spacing: 0.2em; }
