...
const buttonVariants = cva(
  'inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        default: 'bg-primary text-primary-foreground shadow-[var(--shadow-sm)] hover:bg-[var(--primary-hover)]',
        outline: 'border border-border bg-card text-foreground shadow-[var(--shadow-sm)] hover:bg-muted',
        ghost: 'text-foreground hover:bg-muted',
        destructive: 'bg-[var(--destructive)] text-[var(--destructive-foreground)] shadow-[var(--shadow-sm)] hover:opacity-90',
        secondary: 'bg-secondary text-secondary-foreground shadow-[var(--shadow-sm)] hover:bg-[var(--secondary-hover)]',
